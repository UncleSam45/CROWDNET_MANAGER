  ...
  <main>
    ...
    <section class="access-side">
      <form class="panel" id="login">
        ...
        <div class="fineprint"><span class="shield">◇</span><span>Your credentials are used only to authenticate this session and are never stored by CrowdNet Manager.</span></div>
