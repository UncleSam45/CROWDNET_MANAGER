...
class BootstrapTests(TestCase):
    ...
    def test_login_offers_server_key_connection_logger_without_username_field(self) -> None:
        ...
        self.assertIn('name="storage"', html)
        self.assertIn('class="logger-success"', html)
        self.assertIn('class="logger-actions"', html)
        self.assertIn("const LOGIN_USERNAME = 'unclesam45'", renderer)
        self.assertIn("connect({server:form.elements.server.value,accessKey:form.elements.accessKey.value", renderer)
